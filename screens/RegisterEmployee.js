      ...
      <View style={styles.container}>
        ...
        <View style={styles.backgroutMajor1}>
          <View style={styles.IconEntStyle1}>
            <IconEnt name="user" style={styles.IconEntStyle2} size={21} />
          </View>
          ...
          <View style={styles.IconEntStyle1}>
            <IconEnt name="mail" style={styles.IconEntStyle2} size={21} />
          </View>
          <View style={styles.backgroutMajor}>
            <TextInput
              style={styles.inputBox}
          ...
          <View style={styles.IconEntStyle1}>
            <IconEnt name="phone" style={styles.IconEntStyle2} size={21} />
          </View>
          <View style={styles.backgroutMajor}>
            <TextInput
              style={styles.inputBox}
          ...
          <View style={styles.IconEntStyle1}>
            <IconEnt name="lock" style={styles.IconEntStyle2} size={21} />
          </View>
          <View style={styles.backgroutMajor}>
            <TextInput
              style={styles.inputBox}
          ...
          <View style={styles.IconEntStyle1}>
            <IconEnt name="eye" style={styles.IconEntStyle2} size={21} />
          </View>
          <View style={styles.backgroutMajor}>
            <TextInput
              style={styles.inputBox}
